        ...
        <div className="flex items-center gap-3 relative">
          ...
          {reduxState?.fullName ? (
            <>
              ...
              >
                <img
                  src="s://cdn1.vectorstock.com/i/1000x1000/36/15/businessman-character-avatar-isolated-vector-12613615.jpg"
                  alt=""
            ...
            <>
              <span
                onClick={() => setIsDropDownOpen((prev) => !prev)}
                className="border p-2 border-gray text-zomato-400 rounded-full"
              >
        ...
        <div className="gap-4 w-full items-center justify-around flex">
          ...
          {reduxState?.fullName ? (
            <div className="relative w-20">
              <div
                onClick={() => setIsDropDownOpen((prev) => !prev)}
                className="border border-gray-300 text-zomato-400 w-full h-20 rounded-20"
              >
                <img
